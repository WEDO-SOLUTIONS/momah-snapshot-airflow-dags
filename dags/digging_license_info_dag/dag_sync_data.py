# dags/digging_license_info_dag/dag_sync_data.py
...
from include.digging_license_info_dag.helpers import validate_and_convert_row
...
@dag(
    ...
    doc_md="""
    ### Digging License Info Data Sync
