# dags/external_entities_dag/dag_sync_data.py
...
from include.external_entities_dag.helpers import validate_and_convert_row
...
@dag(
    dag_id="external_entities_sync_data",
    default_args=default_args,
    start_date=datetime(2025, 1, 1),
    schedule_interval="@daily",
    catchup=False,
    max_active_runs=1,
    tags=["urbi_pro", "external_entities", "data_sync"],
    doc_md="""
    ### External Entities Data Sync
...
def sync_data_dag():
    ...
    update_schema = TriggerDagRunOperator(
        ...
        trigger_dag_id="external_entities_manage_asset",
