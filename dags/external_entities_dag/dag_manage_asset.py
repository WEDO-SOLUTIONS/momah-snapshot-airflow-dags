# dags/external_entities_dag/dag_manage_asset.py
...
from include.external_entities_dag.helpers import (
    bootstrap_variables,
...
@dag(
    dag_id="external_entities_manage_asset",
    default_args=default_args,
    start_date=datetime(2025, 1, 1),
    schedule=None,
    catchup=False,
    max_active_runs=1,
    tags=["urbi_pro", "external_entities", "asset_management"],
    doc_md="""
