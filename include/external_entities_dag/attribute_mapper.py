...
ATTRIBUTE_MAPPER: Dict[str, Dict[str, Any]] = {
    ...
    "sla_breached": {"en": "SLA Breached", "ar": "مخالفة SLA", "type": "string", "mandatory": False},
    ...
    "received": {"en": "Received Count", "ar": "عدد الوارد", "type": "number", "mandatory": False},
    "closed_completed": {"en": "Closed Completed", "ar": "المغلقة المكتملة", "type": "number", "mandatory": False},
    "closed_rejected": {"en": "Closed Rejected", "ar": "المغلقة المرفوضة", "type": "number", "mandatory": False},
    "p_open": {"en": "Percentage Open", "ar": "النسبة المفتوحة", "type": "number", "mandatory": False},
    "p_reopen": {"en": "Percentage Reopened", "ar": "النسبة المعادة", "type": "number", "mandatory": False},
    "p_late": {"en": "Percentage Late", "ar": "النسبة المتأخرة", "type": "number", "mandatory": False},
    "critical": {"en": "Critical Count", "ar": "عدد الحالات الحرجة", "type": "number", "mandatory": False},
    "ttc": {"en": "Time to Close", "ar": "وقت الإغلاق", "type": "number", "mandatory": False},
    "ttp": {"en": "Time to Process", "ar": "وقت المعالجة", "type": "number", "mandatory": False},
    "completed": {"en": "Completed Count", "ar": "عدد المكتملة", "type": "number", "mandatory": False},
    "processing": {"en": "Processing Count", "ar": "عدد قيد المعالجة", "type": "number", "mandatory": False},
